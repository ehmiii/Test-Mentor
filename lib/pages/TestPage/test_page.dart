...
import 'package:gat_cs_trainer_app/models/user_test_mcqs_model.dart';
        ...
        return Scaffold(
          ...
          body: LayoutBuilder(
            builder: (_, constrains) {
              UserTestMcqsModel? isQuestionAnswered;

              isQuestionAnswered =
                  testController.getUserTestMcqsModel.firstWhereOrNull(
                (e) =>
                    e.question ==
                        testController
                            .getSelectedMcqs[testController.getCurrentMcqsIndex]
                            .question &&
                    e.userEnteredAnswer != "Skipped",
              );
              return Container(
                                                          ...
                                                          content: Center(
                                                            child:
                                                                GestureDetector(
                                                                    ...
                                                                    child: const Text(
                                                                        "Arealdy Answered. Click for Next Question")),
                                                          ),
                                                        ),
                                                      );
                        ...
                        Row(
                          ...
                          children: [
                            CustomButton(
                              ...
                              press: () {
                                if (testController.getCurrentMcqsIndex > 0) {
                                  testController.backQuestion();
                                }
                              },
                            ),
                            CustomButton(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:
                                    Constants.DARK_BLACK_COLOR.withOpacity(.5),
                                offset: const Offset(
                                  3,
                                  3,
                                ),
